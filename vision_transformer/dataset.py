...
class ViTData:
    ...
    def create_dataloader(
        ...
        if self.name == "CIFAR10":
            ...
            return self.create_Fusion_dataloader(
                batch_size=batch_size, shuffle=shuffle
            )
        else:
    ...
    def create_Fusion_dataloader(self,batch_size:int,shuffle:bool):
        data_dir = self.save_dir_path.joinpath("resized")
        data_dir = str(data_dir)
        transform = transforms.Compose([
                    transforms.Resize((384, 384)), 
        ...
        pacmandata = FusionDataset(self.save_dir_path.joinpath('blackened.csv'),data_dir)
